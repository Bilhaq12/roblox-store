...
interface CheckoutFormProps {
  ...
  totalAmount: number;
  onClose: () => void;
  onProceed: (formData: CheckoutFormData) => void;
}
...
const CheckoutForm: React.FC<CheckoutFormProps> = ({
  ...
  // Check if password is required (robux-login & joki categories)
  const isPasswordRequired = product.category === 'robux-login' || product.category === 'joki';
  ...
  const validateForm = (): boolean => {
    ...
    // Validate Password (required for VIP/Login & Joki)
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 bg-gradient-to-br from-roblox-red to-roblox-purple rounded-lg flex items-center justify-center">
          ...
          {isPasswordRequired && (
            <div>
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Password diperlukan untuk {product.category}
              </p>
            </div>
          )}
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
            ...
            <div className="space-y-1 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-gray-900 dark:text-white">Rp {product.price.toLocaleString('id-ID')}</span>
              </div>
